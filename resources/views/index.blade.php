            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="">
                        ...
                        <a href="{{ url('/tambahadmin')}}"> <i class="menu-icon fa fa-plus"></i>Tambah User</a>
                    </li>
                    <li class="menu-title">Tabel Aktor</li><!-- /.menu-title -->
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-list"></i><a href="{{ url('/customer')}}">Lihat Customer</a></li>
                                <li><i class="fa fa-plus"></i><a href="{{ url('/registcustomer')}}">Tambah Customer</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-list"></i><a href="{{ url('/petani')}}">Lihat Petani</a></li>
                                <li><i class="fa fa-plus"></i><a href="{{ url('/formpetani')}}">Tambah Petani</a></li>
                            </ul>
                        </li>
                    ...
                    <li class="menu-icon"><img src="{{ asset('images/hope market.png') }}" width="50px" alt="Hope Market">Hope Market</li><!-- /.menu-title -->
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-list"></i><a href="#">Lihat Kategori</a></li>
                                <li><i class="fa fa-plus"></i><a href="#">Tambah Kategori</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children dropdown">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-list"></i><a href="{{ url('/investasi')}}">Lihat Investasi</a></li>
                                <li><i class="fa fa-plus"></i><a href="{{ url('/registinvestasi')}}">Tambah Investasi</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="menu-item-has-children dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>Invest</a>
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-list"></i><a href="#">Lihat Video</a></li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img src="images/hopedashboard.png" alt="Logo"></a>
